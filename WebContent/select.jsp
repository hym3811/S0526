...
<section>
	<form name=form id=s1>
		<br><h3 style="text-align:center; font-size:1.5em;">직원 정보 조회</h3><br>
		<table border=3 style="width:60%; margin: 0 auto;">
			<tr>
...
%>
			...
			<tr>
				...
				<td style="text-align:center;"><a href="update.jsp?id=<%=id %>" style="color:white;text-decoration:none;"><%=id %></a></td>
